...
namespace MyCustomListUnitTests
{
    ...
    public class SelectionSortTests
    {
        ...
        public void Sort_List135246_ReturnList123456()
        {
            ...
            list1.Add(4);
            list1.Add(6);
            CustomList<int>.SelectionSort(list1);
        ...
        public void Sort_ListDoubles_ReturnList1234()
        {
            ...
            list1.Add(1.1);
            list1.Add(3.3);
            CustomList<double>.SelectionSort(list1);
            actual = list1.ToString();
        ...
        public void Sort_ListAaBbCc_ReturnListABCabc()
        {
            ...
            list1.Add('C');
            list1.Add('c');
            CustomList<char>.SelectionSort(list1);
            actual = list1.ToString();
        ...
        public void Sort_ListTrueFalseTrueFalse_ReturnListFalseFalseTrueTrue()
        {
            ...
            list1.Add(true);
            list1.Add(false);
            CustomList<bool>.SelectionSort(list1);
            actual = list1.ToString();
        ...
        public void Sort_ListWorldHello_ReturnListHelloWorld()
        {
            ...
            list1.Add("World");
            list1.Add("Hello");
            CustomList<string>.SelectionSort(list1);
            actual = list1.ToString();
